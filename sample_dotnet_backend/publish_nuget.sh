...
FEED_URL="https://nuget.pkg.github.com/kabitacodeforge/index.json"
...
echo "✅ Done! Your package should now be visible at https://github.com/kabitacodeforge/end-to-end-data-pipeline/packages"
